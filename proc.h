...
/****edit! Multi-Level feedback queue****/
#define LEN_Queue      37 
typedef struct s_Queue  /*多级就绪队列节点信息*/  
{  
    struct proc* Pro_Queue[LEN_Queue];   /*就绪队列中的进程队列*/  
    int prio;    /*本就绪队列的优先级*/  
    ...
    int rear;
    int maxsize;
    //struct s_Queue *next;  /*指向下一个就绪队列的链表指针*/  
}ReadyQueue;


/* Number of ReadyQueue */
#define NR_Queues	3
#define NULL 0
...
#define STACK_SIZE_TESTN	STACK_SIZE_DEFAULT
